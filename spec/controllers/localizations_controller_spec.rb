...
describe LocalizationsController do
  ...
  describe "GET index" do
    it "assigns all localizations as @localizations" do
      ...
      assigns(:localizations).should eq([localization])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested localization as @localization" do
      ...
      assigns(:localization).should eq(localization)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new localization as @localization" do
      ...
      assigns(:localization).should be_a_new(Localization)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created localization as @localization" do
        post :create, {:localization => valid_attributes}, valid_session
        assigns(:localization).should be_a(Localization)
        assigns(:localization).should be_persisted
      end

      it "redirects to the created localization" do
        post :create, {:localization => valid_attributes}, valid_session
        response.should redirect_to(Localization.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved localization as @localization" do
        ...
        Localization.any_instance.stub(:save).and_return(false)
        post :create, {:localization => {}}, valid_session
        assigns(:localization).should be_a_new(Localization)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested localization" do
        localization = Localization.create! valid_attributes
        # Assuming there are no other localizations in the database, this
        # specifies that the Localization created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Localization.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => localization.to_param, :localization => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the localization" do
        localization = Localization.create! valid_attributes
        put :update, {:id => localization.to_param, :localization => valid_attributes}, valid_session
        response.should redirect_to(localization)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the localization as @localization" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Localization.any_instance.stub(:save).and_return(false)
        put :update, {:id => localization.to_param, :localization => {}}, valid_session
        assigns(:localization).should eq(localization)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the localizations list" do
      localization = Localization.create! valid_attributes
      delete :destroy, {:id => localization.to_param}, valid_session
      response.should redirect_to(localizations_url)
    end
  end
